          ...
          <div className="col-span-2 relative w-full mb-2 md:mb-0">
            <form className="flex items-center">
              ...
              <div className="relative w-full">
                ...
                <input type="text" id="simple-search" value={search} onChange={(e) => setSearch(e.target.value)} className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white block w-full p-1.5 pl-10 text-base rounded-full border-none focus:ring-0 focus:outline-none outline-none" placeholder="Search" required />
              </div>
            </form>
          </div>
            ...
            <div className="flex justify-between gap-2">
              <div className="relative w-1/2">
                <Dropdown label="" dismissOnClick={false} renderTrigger={() => (
                  <button type="button" className="inline-flex bg-white dark:bg-gray-900 text-gray-900 dark:text-white justify-center w-full rounded-full px-4 py-2 text-sm font-medium outline-none">
                    Most
              ...
              <div className="relative w-1/2">
                <Dropdown label="" dismissOnClick={false} renderTrigger={() => (
                  <button type="button" className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white inline-flex justify-center w-full rounded-full px-4 py-2 text-sm font-medium outline-none">
                    Sort by
                    <svg className="h-4 w-auto mt-1 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
                  ...
                  <Dropdown.Item onClick={() => sortBy(product, "oldest")}>Oldest products</Dropdown.Item>
                </Dropdown>
              </div>
            </div>
          </div>
