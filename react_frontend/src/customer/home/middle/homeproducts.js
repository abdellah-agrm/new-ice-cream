...
export default function HomeProducts() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white flex flex-wrap justify-center items-start py-2 px-4" id="products">
      <div className="mb-2">
        <div className="text-center">
          <h1 className="sm:text-4xl text-2xl font-medium title-font mb-4">Our <span className="text-cream-600">Popular</span> Ice Creams</h1>
