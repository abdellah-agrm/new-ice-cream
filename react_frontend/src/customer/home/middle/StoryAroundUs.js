    ...
    <section className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      <div className="container w-9/12 py-12 mx-auto">
        <div className="text-center mb-10" id="aboutus">
          <h1 className="sm:text-4xl text-2xl font-medium title-font mb-4">Story <span className="text-cream-600">Around Us</span></h1>
            ...
            data.map((item, index) => (
              <div key={index} className="p-4 md:w-1/3">
                <div className="h-full bg-cream-200 border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  <Link to="/readmore">
                    <img className="lg:h-48 md:h-36 w-full object-cover object-center" src={process.env.PUBLIC_URL + item.img} alt="blog" />
                  </Link>
                  <div className="p-4">
                    <Link to="/readmore">
