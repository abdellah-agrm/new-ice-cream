...
export default function ContactUs() {
  return (
    <section className="font-poppins pt-4 mb-10" id="contactus">
      <div className="ontainer w-9/12 text-center mx-auto mb-10">
        <h1 className="sm:text-4xl text-2xl font-semibold title-font mb-4">Need Assistance? <span className="text-cream-600">Contact Us</span></h1>
      ...
      <div className="mx-auto relative w-[80%]">
        ...
        <div className="container px-5 py-10 mx-auto flex">
          <div className="lg:w-1/3 md:w-1/2 bg-cream-100/30 backdrop-blur-sm rounded-lg px-8 py-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            <h2 className="text-lg font-semibold text-gray-900 title-font">Contact us</h2>
