...
export default function Hero() {
  ...
  return (
    <section className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white body-font" id="hero">
      <ScrollToTop/>
      <div className="container mx-auto flex px-8 py-8 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <div className="flex justify-between gap-2 w-full">
            <div>
              <button onClick={goToPrevSlide} className="mr-2 rounded-full text-cream-600 p-2 border-2 border-cream-600 hover:bg-cream-600 hover:text-white dark:hover:text-gray-900">
                <ArrowSmallLeftIcon className='w-8 h-auto' />
              </button>
              <button onClick={goToNextSlide} className="rounded-full text-cream-600 p-2 border-2 border-cream-600 hover:bg-cream-600 hover:text-white dark:hover:text-gray-900">
                <ArrowSmallRightIcon className='w-8 h-auto' />
              </button>
            </div>
            <Link to="/products" className="flex flex-row font-medium text-cream-600 bg-transparent border-2 border-cream-600 hover:bg-cream-600 hover:text-white dark:hover:text-gray-900 py-2 px-4 rounded-full text-lg">
