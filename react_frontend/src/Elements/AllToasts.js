...
export const DoneToast = ({ text }) => {
  return (
    <div className="font-poppins bg-white dark:bg-gray-900 text-gray-900 dark:text-white mt-2 flex items-center w-full max-w-xs p-4 border-[1px] border-cream-500 rounded-lg">
