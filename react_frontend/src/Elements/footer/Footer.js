...
export default function Footer() {
  const icons = [
    {
      icon: <Twitter className="h-5 w-auto text-white dark:text-gray-900" />,
      link: "https://twitter.com"
    },
    {
      icon: <Instagram className="h-5 w-auto text-white dark:text-gray-900" />,
      link: "https://instagram.com"
    },
    {
      icon: <Youtube className="h-5 w-auto text-white dark:text-gray-900" />,
      link: "https://youtube.com"
    },
    {
      icon: <Linkedin className="h-5 w-auto text-white dark:text-gray-900" />,
      link: "https://linkedin.com/in/abdellah-agourram"
    },
    {
      icon: <Github className="h-5 w-auto text-white dark:text-gray-900" />,
      ...
      <div className="container px-5 py-8 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a href="#_" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <h1 className="text-4xl text-center font-black font-dmserif dark:text-white text-gray-900">IceCream</h1>
          </a>
            ...
            Array.from({ length: 3 }).map((_, index) => (
              <div key={index} className="lg:w-1/3 md:w-1/2 w-full px-4">
                ...
                <nav className="list-none font-medium mb-10">
                  <li><a href="#_" className="text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-cream-500">Home</a></li>
                  <li><a href="#_" className="text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-cream-500">Our products</a></li>
                  <li><a href="#_" className="text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-cream-500">Our story</a></li>
                  <li><a href="#_" className="text-gray-600 hover:text-gray-900 dark:text-white dark:hover:text-cream-500">Contact us</a></li>
                </nav>
              </div>
            ))
          }
